...
When the mesh is created, with specific names for the volumes and surfaces, export it in `.med` (example : `example_mesh.med`) with `Salome`.
...
This will create a new file, call `example_mesh_p4.json` that you will use in your configure file.
