...
include::01-installation/docker.adoc[leveloffset=+1]
include::01-installation/lncmi-repository.adoc[leveloffset=+1]
include::01-installation/from-scratch.adoc[leveloffset=+1]


= Using {hifimagnet}

include::04-learning/README.adoc[leveloffset=+1]
include::04-learning/Optimization.adoc[leveloffset=+1]
include::04-learning/Geometry.adoc[leveloffset=+1]
include::04-learning/AxiModeling.adoc[leveloffset=+1]
include::04-learning/3DModeling.adoc[leveloffset=+1]

= Modeling an PolyHelix Insert from scratch with {hifimagnet}

include::06-programming/README.adoc[leveloffset=+1]
include::06-programming/Optimization.adoc[leveloffset=+1]
include::06-programming/CAD.adoc[leveloffset=+1]
include::06-programming/Mesh.adoc[leveloffset=+1]
include::06-programming/AxiModeling.adoc[leveloffset=+1]
include::06-programming/3DModeling.adoc[leveloffset=+1]
