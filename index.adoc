...
Magn\'etiques Intenses] (LNCMI) is a French large scale facility cite:[LNCMI2013] enabling researchers 
...
http://irma.math.unistra.fr/[Institut de Recherche Math\'ematique Avanc\'ee] (IRMA) and
