...
see this video::cad.mp4[video] for details.
...
see this video::netgen-mesh.png[video] for details

To create a mesh using {meshgems} see this video::meshgem-mesh.png[video].
