...
The singularity image will be downloaded to a file name: `hifimagnet-salome-8.3.0.simg`.
...
----
module load singularity
singularity run --nv -B ${LICDIR}:/opt/DISTENE/DLim:ro --app salome ${SREGISTRY_STORAGE}/hifimagnet-salome-8.4.0.simg  
----
