...
To create a mesh using {netgen} take a look a the video bellow.

video::netgen-mesh.mp4[]

To create a mesh using {meshgems} take a look a the video bellow.

video::meshgems-mesh.mp4[]
