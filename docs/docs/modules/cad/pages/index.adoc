...
<1> name of the CAD geometry (usually this name comes from the Bureau d'Etudes nomemclature to keep track of the CADs)
...
----
<0> header
<1> `theta`, 'Z_i` defines the coordinates of the point in a 2D cartesian frame (note: ) and `Shape_id`
