...
// | *hpc_partition*            | "stokes"                            | "euler"                     | "thin-node, thin-shared,..."
...
|===
| Key                        | *stokes*                            | cesga
| hpc_basedir                | ${HOME}                             | ${LUSTRE}
| hpc_feelpp                 | ${HOME}/feel                        | ${LUSTRE}/feel
| hpc_modules                | -                                   | [gcc/6.3.0, openmpi/2.0.2, singularity/2.4.2] 
| hpc_volumes                | ${HOME}/feel:/feel                  | /scratch,/mnt,${LUSTRE}/feel:/feel
| *hpc_partition*            | "stokes"                            | "thinnodes, thin-shared,..." (see {file:///home/LNCMI-G/trophime/Downloads/FTII_Quick_start_guide.pdf}[doc] for details)
| hpc_reservation            | N/A                                 | optional
| sregistry_storage          | ${HOME}/singularity_images          | `${LUSTRE}/singularity_images`
|===
...
* The list of partitions for {cesga} may be found https://www.cesga.es/es/paginas/descargaDocumento/id/231[here]
====