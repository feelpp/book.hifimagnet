...
* xref::dev.adoc[*DevUser*]
* xref::user.adoc[*EndUser*]
...
he or she can run the purchased offering provided that some fields are properly filled as in this xref::user.adoc#running [example].
