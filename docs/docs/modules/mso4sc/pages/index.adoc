...
* to connect to the {uri-msoportal-dev-www}[Canary Portal],
...
The user that have already an account on the {uri-msoportal-dev-www}[Canary Portal] may skip the next section
...
[[connect]]
== Get an account on *MSO4SC Canary Portal*

Connect to {uri-msoportal-dev-www}[Canary MSOPortal]

image::CanaryMSO4SC.png[login page Canary MSOPortal]

* Click on *login*

You will be forwarded to IDM component of the portal.

image::PortalMSO4SC_idm.png[IDM component of Canary MSOPortal]

* *Sign up* to get an account

image::PortalMSO4SC_signup.png[IDM component of Canary MSOPortal]
...
image::CanaryMSO4SC_login.png[Main page for Canary MSOPortal]

the canary portal is split into several services:
...
The following services are not available from the Canary MSOPortal:

* *Marketplace*, where you can add and/or purchase applications
* *Data Catalogue*, where you can add and/or retrieve data

You have to connect to the main MSOPortal if you ever want to access these services.
...
[NOTE]
====
For smooth operations of {uri-msoportal-dev-www}[portal], the following ports have to be *open*:
...
* click on *Container* main menu to access to {cesga} {sregistry}
...
* https://github.com/MSO4SC/MSOPortal/blob/canary/portal/README.adoc#visualization--pre--post-tool[portal usage]
* https://raw.githubusercontent.com/MSO4SC/resources/canary/blueprint/feelpp/hifimagnet_gen/upload/blueprint.yaml[blueprints examples]
