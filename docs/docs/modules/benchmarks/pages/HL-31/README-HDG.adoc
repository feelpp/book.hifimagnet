...
The data files may be retreived from this https://github.com/feelpp/hifimagnet.cases/tree/v0.108/HL-31-HDG[repository].
The mesh files are stored in collection hifimanget/cases/v0.108/HL-31-HDG collection on {uri-girder}[Unistra Girder] 
