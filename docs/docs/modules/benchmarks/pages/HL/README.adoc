...
[source,sh]
----
mpirun -np 4 feelpp_hfm_thermoelectric --case "github:{path:toolboxes/thermoelectric/ElectroMagnets/HL-31_H1}"
----
...
[source,json,,indent=0]
----
include::{examplesdir}/HL/HL-31_H1_nonlinear.json[tags=nonlinear]
----
...
[source,json,,indent=0]
----
include::{examplesdir}/HL/HL-31_H1_nonlinear.json[tags=bc-pot]
----
...
[source,json,,indent=0]
----
include::{examplesdir}/HL/HL-31_H1_nonlinear.json[tags=bc-temp]
----
...
[source,json,,indent=0]
----
include::{examplesdir}/HL/HL-31_H1_nonlinear.json[tags=export]
----

image:HL/electromagnet.png[100%]
