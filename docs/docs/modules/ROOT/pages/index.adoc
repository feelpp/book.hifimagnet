...
>>>>>>> 364a2fdde76d9312d3173171a883acfb28ee2440
...
<<<<<<< HEAD
{uri-irma-www}[Institut de Recherche Mathématique Avancée] (IRMA) and {uri-cemosis-www}[Centre for modeling and simulation in Strasbourg] (Cemosis).
=======
...
The recommended and easiest way to use {hifimagnet} is through the portal.
The impatient reader could directly go this xref:mso4c:index.adoc#msoportal[section] for pratical details and
some examples.
=======
>>>>>>> 364a2fdde76d9312d3173171a883acfb28ee2440
...
<<<<<<< HEAD
* simulate the 3D behaviour of of the magnet with xref:user:index.adoc#user_manual[{hifimagnet}].
=======
