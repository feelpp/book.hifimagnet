...
to perform experiments in the highest possible magnetic field. DC magnetic fields up to 37 T are provided at the Grenoble site 
...
[options="header"]
|===
^.^| xref:cad:ROOT:index.adoc[image:HL-31-cadgeom.png[insert_cad,200]] ^.^| xref:user_h:ROOT:index.adoc[image:HL-31-model.png[insert_disp,200]] ^.^| xref:benchmarks_h:ROOT:index.adoc[image:bitter-adapt.png[Bitter,200]]
^.^| xref:cad:ROOT:index.adoc[CAD manual]    ^.^| xref:user_h:ROOT:index.adoc[User manual] ^.^| xref:benchmarks_h:ROOT:index.adoc[Benchmarks manual]
|===


// include::xref:0.104@user:ROOT:index.adoc#Conventions[Conventions]
