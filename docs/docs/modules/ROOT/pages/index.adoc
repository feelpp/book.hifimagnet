...
include::_partials/header-macro.adoc[]
include::_partials/header-uri.adoc[]
include::_partials/mso4sc-uri.adoc[]
...
[cols="4",frame="none"]
|===
^.^| xref:model_h:ROOT:index.adoc[image:Model.png[model,300]]
^.^| xref:cad:ROOT:index.adoc[image:HL-31-cadgeom.png[insert_cad,200]]
^.^| xref:user_h:ROOT:index.adoc[image:HL-31-model.png[insert_disp,200]]
^.^| xref:benchmarks_h:ROOT:index.adoc[image:bitter-adapt.png[Bitter,300]]
^.^| xref:model_h:ROOT:index.adoc[Model manual]
^.^| xref:cad:ROOT:index.adoc[CAD manual]
^.^| xref:user_h:ROOT:index.adoc[User manual]
^.^| xref:benchmarks_h:ROOT:index.adoc[Benchmarks manual]
|===
