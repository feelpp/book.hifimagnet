...
//   <script> 
//     function makeplot() {
// 	Plotly.d3.csv("https://media.githubusercontent.com/media/feelpp/book.hifimagnet/master/docs/docs/modules/appendix/attachments/M9_2019.06.20-14_36_30.csv", function(data){ processData(data) } );
...
<div class="showcase__section" id="bubble">
  ...
  <div id="bubbleplots">
   ...
   <script> 
Plotly.d3.csv("https://media.githubusercontent.com/media/feelpp/book.hifimagnet/master/docs/docs/modules/appendix/attachments/M9_2019.06.20-14_36_30.csv", function(err, rows){
