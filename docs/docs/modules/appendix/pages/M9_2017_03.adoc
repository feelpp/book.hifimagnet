...
image::{imagesdir}/M9_10_03_2k17.png[Temperature and Magnetic Field profile during experiment]

In this example we will try to reproduce the behaviour of an 14 Helices insert
operated on March 2017. More precisely, we will compare:
...
image::{imagesdir}/M9_10_03_2k17_Vprobes.png[Relative error for Voltage taps for each simulation.]
