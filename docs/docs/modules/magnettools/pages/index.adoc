...
To get {hifimagnet} singularity image see xref:user/index.adoc[singularity]

=== from dockerhub

{magnettools} are included in {hifimagnet} docker image.
To get {hifimagnet} docker image see xref:user/index.adoc[dockerhub]
