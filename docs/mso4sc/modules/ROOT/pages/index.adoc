...
To finalize your registration, you need to ask to become a *DevUser*.
This may done by sending email to *Portal Admins* (who? actually Victor or Javi).
...
he or she can run the purchased offering provided that some fields are filled properly as in this <<, example>>.
