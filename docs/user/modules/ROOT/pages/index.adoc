...
Using {hifimagnet} inside <<docker/what-is-docker.adoc#what-is-docker,Docker>> is the recommended and fastest way to use {hifimagnet}.
The <<docker/README.adoc#docker,Docker>> chapter is dedicated to Docker and using {feelpp} in Docker.
